...
SELECT DISTINCT StudentId FROM high_gpa JOIN StudentRegistrationsToDegrees as srtd ON high_gpa.StudentRegistrationId = srtd.StudentRegistrationId WHERE high_gpa > %1% ORDER BY StudentId;
SELECT 0;
SELECT 0;
SELECT 0;
SELECT 0;
